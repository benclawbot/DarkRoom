...
assert(sw.includes('darkroom-v22')&&sw.includes('engine-core.js')&&sw.includes('generative-runtime.js')&&sw.includes('docs/assets/examples/'),'Service worker v22 assets missing');
