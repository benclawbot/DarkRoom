...
assert(sw.includes('darkroom-v21')&&sw.includes('engine-core.js')&&sw.includes('generative-runtime.js')&&sw.includes('docs/assets/examples/'),'Service worker v21 assets missing');
