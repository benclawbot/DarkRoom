...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.evaluate("setEditorFallback(true)");assert page.locator('#editorFallbackImage').is_visible();assert 'blob:' in (page.locator('#editorFallbackImage').evaluate("el=>getComputedStyle(el).backgroundImage") or '');page.evaluate("setEditorFallback(false)");assert not page.locator('#editorFallbackImage').is_visible()
