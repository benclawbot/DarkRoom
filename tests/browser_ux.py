...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.set_input_files('#fileInput',[{'name':'mountain-one.png','mimeType':'image/png','buffer':sample_png(0)},{'name':'mountain-two.png','mimeType':'image/png','buffer':sample_png(1)}])
