...
const maskFeather=read('mask-feather.js');
const maskVisibility=read('mask-overlay-visibility.js');
...
assert(maskVisibility.includes('m.uiVisible===true||strokeActive')&&maskVisibility.includes("style.setProperty('opacity',visible?'1':'0','important')"),'Mask overlay visibility must obey the eye preference between brush strokes');
assert(html.includes('mask-interaction.js?v=1')&&html.includes('mask-feather.js?v=1')&&html.includes('mask-overlay-visibility.js?v=1'),'Mask interaction, feather, and visibility runtimes must be loaded by the editor');
...
assert(sw.includes("darkroom-v30")&&sw.includes('refine-ui.js')&&sw.includes('presetpro-presets.js')&&sw.includes('mask-interaction.js?v=1')&&sw.includes('mask-feather.js?v=1')&&sw.includes('mask-overlay-visibility.js?v=1')&&sw.includes('crop-ui.js?v=26')&&sw.includes('performance-ui.js?v=2')&&sw.includes('preview-geometry.js?v=1'),'Refined editor assets missing from offline shell');
